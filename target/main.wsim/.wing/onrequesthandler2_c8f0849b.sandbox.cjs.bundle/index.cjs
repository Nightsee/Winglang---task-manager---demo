...
// target/main.wsim/.wing/inflight.$Closure6-5.cjs
var require_inflight_Closure6_5 = __commonJS({
  "target/main.wsim/.wing/inflight.$Closure6-5.cjs"(exports2, module2) {
    "use strict";
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure6Client = require_inflight_Closure6_5()({
          $deleteTask: function() {
            let handle = process.env.FUNCTION_HANDLE_c2c6575e;
            if (!handle) {
              throw new Error("Missing environment variable: FUNCTION_HANDLE_c2c6575e");
            }
