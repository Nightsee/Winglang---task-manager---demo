...
// target/main.wsim/.wing/inflight.$Closure2-4.cjs
var require_inflight_Closure2_4 = __commonJS({
  "target/main.wsim/.wing/inflight.$Closure2-4.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_2_tableName, $adminEndpoint }) {
      class $Closure2 {
        static {
...
// target/main.wsim/.wing/handler_c8749bb9.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $Closure2Client = require_inflight_Closure2_4()({
