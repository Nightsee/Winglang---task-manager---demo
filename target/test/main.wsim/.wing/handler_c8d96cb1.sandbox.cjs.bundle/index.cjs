...
// target/test/main.wsim/.wing/inflight.$Closure1-4.cjs
var require_inflight_Closure1_4 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure1-4.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $__parent_this_1_tableName }) {
      class $Closure1 {
        static {
        ...
        async handle() {
          return $__parent_this_1_tableName;
        }
      }
      return $Closure1;
    };
...
// target/test/main.wsim/.wing/handler_c8d96cb1.sandbox.cjs
var $handler = void 0;
