...
// target/main.wsim/.wing/inflight.$Closure5-5.cjs
var require_inflight_Closure5_5 = __commonJS({
  "target/main.wsim/.wing/inflight.$Closure5-5.cjs"(exports2, module2) {
    "use strict";
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure5Client = require_inflight_Closure5_5()({
          $addTask: function() {
            let handle = process.env.FUNCTION_HANDLE_fde1aa9c;
            if (!handle) {
              throw new Error("Missing environment variable: FUNCTION_HANDLE_fde1aa9c");
            }
