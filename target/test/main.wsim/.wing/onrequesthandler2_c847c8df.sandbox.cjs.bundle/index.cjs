...
// target/test/main.wsim/.wing/inflight.$Closure6-5.cjs
var require_inflight_Closure6_5 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure6-5.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $deleteTask, $std_Json }) {
      class $Closure6 {
        static {
...
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure6Client = require_inflight_Closure6_5()({
          $deleteTask: function() {
            let handle = process.env.FUNCTION_HANDLE_930bbb00;
            if (!handle) {
              throw new Error("Missing environment variable: FUNCTION_HANDLE_930bbb00");
            }
