...
// target/main.wsim/.wing/inflight.$Closure4-5.cjs
var require_inflight_Closure4_5 = __commonJS({
  "target/main.wsim/.wing/inflight.$Closure4-5.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $getTasks, $std_Json }) {
      class $Closure4 {
        static {
        ...
        async handle() {
          ...
          if ($helpers.eq($helpers.lookup(tmp, "success"), true)) {
            ...
            })({ "tasks": $helpers.lookup(tmp, "tasks") }) };
          } else {
...
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    ...
    const $ctx = {
      handler: await (async () => {
        const $Closure4Client = require_inflight_Closure4_5()({
          $getTasks: function() {
            let handle = process.env.FUNCTION_HANDLE_71989835;
            if (!handle) {
              throw new Error("Missing environment variable: FUNCTION_HANDLE_71989835");
            }
